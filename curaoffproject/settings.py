"""
Django settings for curaoffproject project.
...
SECRET_KEY = '$_8mu%xx+!28y__nyuo=o3m$)@6q-m-51v*3ng^z0r#i-lu+c0'
...
ROOT_URLCONF = 'curaoffproject.urls'
...
WSGI_APPLICATION = 'curaoffproject.wsgi.application'
